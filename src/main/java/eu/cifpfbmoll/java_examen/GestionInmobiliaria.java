...
public class GestionInmobiliaria {
    ...
    public static void loginInmobiliaria(ArrayList<Inmobiliaria> listaInmobiliarias) throws Exception{
    ...
    public static void acederMenuPrincipal(ArrayList<Inmobiliaria> listaInmobiliarias) throws Exception{
     ...
     */
    public static void llamarMenuInmobiliaria(ArrayList<Inmueble> listaInmuebles) throws Exception {
